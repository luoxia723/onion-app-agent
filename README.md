...
项目每天最多只读检查一次更新，只有发现新版本才询问。用户也可以随时在Codex里说“更新项目到最新”；Git仓库会安全快进，ZIP工作目录第一次会自动接入对应公开GitHub仓库。更新流程不影响`工作区/`或`.runtime/`中的任务文件，只会维护明确登记的本地运行状态。
